...
const legalContent = {
  ...
  datenschutz: {
    eyebrow: 'DEINE DATEN',
    title: 'Datenschutz',
    body: <><h3>1. Verantwortlicher</h3><p>Graffiti Smash Burgers, Oberbachstraße 4, 37603 Holzminden<br/>E-Mail: <a href="mailto:info@graffitismash.de">info@graffitismash.de</a></p><h3>2. Hosting und Server-Logfiles</h3><p>Beim Aufruf dieser Website kann der Hostinganbieter technisch notwendige Verbindungsdaten verarbeiten, insbesondere IP-Adresse, Zeitpunkt, aufgerufene Datei, Referrer und Browserinformationen. Die Verarbeitung dient der sicheren und stabilen Bereitstellung der Website auf Grundlage von Art. 6 Abs. 1 lit. f DSGVO.</p><h3>3. Datensparsame Besucherstatistik</h3><p>Wir zählen Seitenaufrufe und ungefähre eindeutige Besucher mit einer eigenen, serverseitigen Lösung ohne externe Analysedienste. Dabei wird eine zufällige Kennung in einem technisch geschützten First-Party-Cookie gespeichert und ausschließlich in gehashter Form mit dem Besuchstag verarbeitet. Die Statistik speichert keine IP-Adresse und wird nach spätestens 395 Tagen gelöscht. Rechtsgrundlage ist unser berechtigtes Interesse an der Reichweitenmessung und Verbesserung unseres Angebots gemäß Art. 6 Abs. 1 lit. f DSGVO.</p><h3>4. Kartendarstellung</h3><p>Die interaktive Karte wird mit MapLibre und Kartenkacheln von CARTO bereitgestellt. Beim Laden der Karte wird technisch bedingt eine Verbindung zu CARTO hergestellt, wobei insbesondere die IP-Adresse übertragen werden kann. Kartendaten basieren auf OpenStreetMap-Beiträgen.</p><h3>5. Bestellungen</h3><p>Zur Durchführung einer Bestellung verarbeiten wir Name, E-Mail-Adresse, Telefonnummer, Bestellinhalt, Abholzeit und freiwillige Anmerkungen. Rechtsgrundlage ist Art. 6 Abs. 1 lit. b DSGVO. Abgeschlossene Bestellungen werden im operativen System grundsätzlich nach 90 Tagen entfernt; gesetzlich aufbewahrungspflichtige Geschäftsunterlagen können außerhalb dieses Systems länger gespeichert werden.</p><h3>6. Bestellbenachrichtigungen</h3><p>Wenn die entsprechende Schnittstelle aktiviert wurde, werden Bestelldaten über den konfigurierten E-Mail-Anbieter und Telegram an das Restaurant übermittelt. Dabei können Daten durch die jeweiligen Anbieter verarbeitet werden. Die Benachrichtigungen dienen der Durchführung des Vertrags gemäß Art. 6 Abs. 1 lit. b DSGVO.</p><h3>7. Kontaktaufnahme</h3><p>Wenn Sie uns per E-Mail oder Telefon kontaktieren, verarbeiten wir Ihre Angaben zur Bearbeitung der Anfrage gemäß Art. 6 Abs. 1 lit. b oder lit. f DSGVO.</p><h3>8. Ihre Rechte</h3><p>Sie haben insbesondere Rechte auf Auskunft, Berichtigung, Löschung, Einschränkung, Datenübertragbarkeit und Widerspruch sowie ein Beschwerderecht bei einer Datenschutzaufsichtsbehörde.</p><p className="legal-note">Stand: Juli 2026. Vor dem Produktivbetrieb sind die konkreten Hosting-, SMTP- und Telegram-Anbieter sowie Auftragsverarbeitungsverträge vom Verantwortlichen zu prüfen und gegebenenfalls hier zu ergänzen.</p></>,
  },
}
